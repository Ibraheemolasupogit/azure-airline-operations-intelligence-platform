...
Milestones 4 and 5 introduce local passenger-demand forecasting and flight-delay prediction
evidence. The workflows are deterministic, auditable, and scoped to synthetic data.
...
The passenger-demand and flight-delay models are decision-support demonstrations over fictional
synthetic data. They are not production revenue-management models, pricing models,
safety-critical systems, dispatch authorities, or autonomous operations-control systems.
...
Azure ML registration, endpoints, credentials, or cloud resources are created in Milestones 4 or 5.
